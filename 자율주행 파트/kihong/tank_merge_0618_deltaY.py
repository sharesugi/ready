...
MODEL_PATH = "/home/kkh94df/jupyter_home/team_project/merge/best_dnn_model.h5"
XGB_PATH = "/home/kkh94df/jupyter_home/team_project/merge/best_xgb_model.pkl"
SCALER_PATH = "/home/kkh94df/jupyter_home/team_project/merge/scaler.pkl"
POLY_PATH = "/home/kkh94df/jupyter_home/team_project/merge/poly_transformer.pkl"
...
app = Flask(__name__)
model_yolo = YOLO('/home/kkh94df/jupyter_home/team_project/merge/best_8s.pt')
...
destination_x = 270 # 기존에는 destination과 적 전차 위치를 똑같이 줬으나, LiDAR로 물체를 감지할 경우 적 전차도 감지해서 장애물이라 생각하고 목표에 끝까지 도달을 안함. 그래서 이제부터 따로 줌.
destination_z = 50
...
def get_info():
    global true_hit_ratio, s_time, lidar_data, MOVE_MODE, enemy_pos
    ...
    for point in lidar_data:
        ...
        if vertical_angle > 6 or vertical_angle < -1 :
            continue
    ...
    clustering = DBSCAN(eps=1.0, min_samples=2).fit(points_np)
...
def init():
    global start_distance, MOVE_MODE, enemy_pos
