...
# 결과
# image 1/1 /home/user/jupyter_home/tank/temp_image.jpg: 384x640 1 tank, 94.6ms
# Speed: 3.0ms preprocess, 94.6ms inference, 2.0ms postprocess per image at shape (1, 3, 384, 640)
# class명: tank, Bound Box의 좌표: [      300.3      193.82      339.03      227.88]
# [디버그] bbox 중심 좌표: (319.7, 210.9)
# [디버그] 정규화된 이미지 좌표: (-0.001, 0.098)
# [테스트] direction: [-0.00043533    -0.02399     0.99971]
# [디버그] 카메라 기준 광선 방향 벡터: [-0.00043533    -0.02399     0.99971]
# [디버그] 월드 기준 광선 방향 벡터: [-0.00043533    -0.02399     0.99971]
# [디버그] 카메라 위치: [     60.007      11.001      200.35]
# 탐지된 전차 위치: x=60.01, y=8.72, z=276.61
# **[디버그] 실제 전차 위치: (60.00, 10.00, 280.00)**
# **[디버그] 탐지된 전차 위치와 실제 위치 간 오차: 3.62**
# **[디버그] LiDAR 원점과 탐지된 전차 간 거리: 76.29**